...
class Dev(Configuration):
    ...
    ADMINS = [("Saad", "saadalsaad00@gmail.com")]
    ...
    # OMDB_KEY = values.SecretValue()  # set env using this command export DJANGO_OMDB_KEY=abc123 before running python manage.py ...
    OMDB_KEY = "84d47d74"
