...
OMDB_API_URL = "https://www.omdbapi.com/" #can be in settings with different URLs if we have both Dev and Production class
    ...
    def search(self, search):
        ...
        while True:
            ...
            if total_results is None:
                total_results = resp_body.get("totalResults")
